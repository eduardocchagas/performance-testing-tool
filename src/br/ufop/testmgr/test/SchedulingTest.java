...
public class SchedulingTest {
	...
	public static void main(String[] args) {
		...
		int y_times = 8; // testes serao executados num total de 3
		// vezes
		long x_in_x_seconds = 3 * 60 * 1000; // cada teste inicia
		...
		/*
		testSchedule
				.loadTestSuiteConfiguration("src/com/sensedia/testmgr/executionconfig/teste.xml");
